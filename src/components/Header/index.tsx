               ...
               <div className="row items-center">
                  <div className="w-full">
                     <nav className="flex items-center justify-between py-3 navbar navbar-expand-lg">
                           ...
                           <ul id="nav" className="items-center content-start mr-auto lg:justify-end navbar-nav lg:flex py-3">
                              {NavbarLinks.map((link) => (
                                 <li key={link.slug} className="nav-item text-xl mr-5 lg:mr-16">
                                    <HashLink smooth to={link.slug}>{link.name}</HashLink>  {/* active */}
                                 </li>
                              ))}
                           </ul>
                        </div>
                        ...
                        <Link to="/" className="lg:hidden text-white text-3xl">
                           Portfolio
                        </Link>

                        <div className="hidden lg:block text-center">
                           <ul className="flex justify-center items-center sm:justify-start gap-6">
                              <li><Link target="_blank" to="https://www.linkedin.com/in/mohammadaliamidi/"><i className="lni lni-linkedin-original text-lg hover:text-emerald-400 duration-200"></i></Link></li>
                              <li><Link target="_blank" to="https://github.com/mohammadali-amd/"><i className="lni lni-github-original text-lg hover:text-emerald-400 duration-200"></i></Link></li>
                              <li><Link to="tel:09104971545"><i className="lni lni-whatsapp text-lg hover:text-emerald-400 duration-200"></i></Link></li>
                              <li><Link to="mailto:amidi1380@gmail.com"><i className="lni lni-envelope text-lg hover:text-emerald-400 duration-200"></i></Link></li>
                           </ul>
                        </div>
                     </nav>
                  </div>
