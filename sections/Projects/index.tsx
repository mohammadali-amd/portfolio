   ...
   return (
      <section id="projects" className="work_area pt-120 pb-120">
                              ...
                              <div className="single_team_item rounded-xl shadow-lg mx-auto group">
                                 <div className="single_team">
                                    <div className="team_image relative">
                                       <div>
                                          ...
                                          <Image
                                             src={item.mainImage}
                                             alt={item.name}
                                             className="absolute top-0 h-[300px] object-contain backdrop-blur-[8px]"
                                             width={500}
                                             height={500}
                                          />
                                       </div>
                                       <ul className="social absolute top-4 right-8">
                                          <li><Link target='_blank' href={item.website ? item.website : '#'}><i className="lni lni-link"></i></Link></li>
                                          <li><Link target='_blank' href={item.github ? item.github : '#'}><i className="lni lni-github-original"></i></Link></li>
                                       </ul>
                                    </div>
                                    <div className="text-center py-5 space-y-4 px-8 ">
                                       ...
                                       <Link href={`/projects/${item.slug}`} className='text-lg flex justify-center bg-theme-color py-2 rounded-md group-hover:bg-white group-hover:text-theme-color'>Details</Link>
                                    </div>
                                 </div>
                              </div>
                           </div>
         ...
         <div className="flex justify-center pt-8">
            <Link href='/projects' className="bg-theme-color hover:bg-theme-color/80 rounded-lg px-4 py-2 text-2xl shadow-lg shadow-theme-color/30">
               See More Projects ➡
            </Link>
         </div>
      </section>
