                  ...
                  <div className="contact_wrapper mt-11">
                     <div className="section_title pb-4">
                        ...
                        <div className="pt-12 space-y-12 md:space-y-0 md:flex md:justify-between md:gap-3">
                           {/* Linkedin */}
                           <Link target="_blank" href="https://www.linkedin.com/in/mohammadaliamidi/" className="grid justify-items-center hover:text-theme-color" rel="noreferrer">
                              <i className="lni lni-linkedin-original text-3xl"></i>
                              <span className="text-lg mt-3">Linkedin</span>
                           </Link>
                           {/* Github */}
                           <Link target="_blank" href="https://github.com/mohammadali-amd" className="grid justify-items-center hover:text-theme-color" rel="noreferrer">
                              <i className="lni lni-github-original text-3xl"></i>
                              <span className="text-lg mt-3">Github</span>
                           </Link>
                           {/* Whatsapp */}
                           <Link target="_blank" href="tel:09104971545" className="grid justify-items-center hover:text-theme-color" rel="noreferrer">
                              <i className="lni lni-whatsapp text-3xl"></i>
                              <span className="text-lg mt-3">0910 497 1545</span>
                           </Link>
                           {/* Email */}
                           <Link target="_blank" href="mailto:amidi1380@gmail.com" className="grid justify-items-center hover:text-theme-color" rel="noreferrer">
